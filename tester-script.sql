...
CREATE TABLE Vet (vetLicenseID INTEGER CONSTRAINT vet_pk PRIMARY KEY, vetName VARCHAR2(50));
...
CREATE TABLE ItemPrice (itemID INTEGER CONSTRAINT itp_pk PRIMARY KEY, total INTEGER);
